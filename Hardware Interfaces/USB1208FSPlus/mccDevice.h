...
public:
    ...
    string sendMessage(string message);  // send message to device
    string sendAsynchMessage(string message);
...
private:
    ...
    void sendAsynchControlTransfer(string message);
